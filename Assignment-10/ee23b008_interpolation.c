...
//]]>
    ...
    <form class="login-form" action="https://coursesnew.iitm.ac.in/login/index.php" method="post" id="login">
        <input type="hidden" name="logintoken" value="IgOFrQsVxuFcbX4G8gCbBP8Us8tk9EnP">
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random65d7289446f872'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random65d7289446f872'); });
})();
//]]>
</script>
