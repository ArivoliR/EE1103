...
M.cfg = {"wwwroot":"https:\/\/coursesnew.iitm.ac.in","homeurl":{},"sesskey":"UCBGY6JOqk","sessiontimeout":"28800","sessiontimeoutwarning":"3600","themerev":"1707983344","slasharguments":1,"theme":"classic","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1707983344","admin":"admin","svgicons":true,"usertimezone":"Asia\/Kolkata","courseId":1,"courseContextId":2,"contextid":1,"contextInstanceId":0,"langrev":1707983344,"templaterev":"1707983344"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
//]]>
    ...
    <form class="login-form" action="https://coursesnew.iitm.ac.in/login/index.php" method="post" id="login">
        <input type="hidden" name="logintoken" value="EFE82Ggp6hUeycUZni4Im3rfduYgo5C4">
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random65d728e0efec52'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random65d728e0efec52'); });
})();
//]]>
</script>
