...
//]]>
    ...
    <form class="login-form" action="https://coursesnew.iitm.ac.in/login/index.php" method="post" id="login">
        <input type="hidden" name="logintoken" value="ECHd6cBPHDDMVNPoAOCnd14Gm2m3HQUv">
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random65d7286e0f2f12'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random65d7286e0f2f12'); });
})();
//]]>
</script>
