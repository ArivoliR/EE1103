...
//]]>
    ...
    <form class="login-form" action="https://coursesnew.iitm.ac.in/login/index.php" method="post" id="login">
        <input type="hidden" name="logintoken" value="IainxgRcwv4lO9Cu4aKIwv2IDO4krTwK">
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random65d727bd8b57d2'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random65d727bd8b57d2'); });
})();
//]]>
</script>
